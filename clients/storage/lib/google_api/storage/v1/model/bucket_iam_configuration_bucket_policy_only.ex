...
defmodule GoogleApi.Storage.V1.Model.BucketIamConfigurationBucketPolicyOnly do
  ...
  - enabled (boolean()): If set, access checks only use bucket-level IAM policies or above. Defaults to `nil`.
  - lockedTime (DateTime.t): The deadline time for changing iamConfiguration.bucketPolicyOnly.enabled from true to false in RFC 3339 format. iamConfiguration.bucketPolicyOnly.enabled may be changed from true to false until the locked time, after which the field is immutable. Defaults to `nil`.
  """
