...
defmodule GoogleApi.Gmail.V1.RequestBuilder do
  ...
  def decode(%Tesla.Env{body: body}, struct, dataWrapped: true) do
    Poison.decode(body, as: %GoogleApi.Gmail.V1.RequestBuilder.DataWrapper{}, struct: struct)
    |> case do
...
defimpl Poison.Decoder, for: GoogleApi.Gmail.V1.RequestBuilder.DataWrapper do
