...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ReidentifyContentRequest do
  ...
  - item (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ContentItem.t): The item to re-identify. Will be treated as text. Defaults to `nil`.
  - reidentifyConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeidentifyConfig.t): Configuration for the re-identification of the content item.
  ...
  - `CryptoReplaceFfxFpeConfig` Defaults to `nil`.
  - reidentifyTemplateName (String.t): Optional template to use. References an instance of `DeidentifyTemplate`.
