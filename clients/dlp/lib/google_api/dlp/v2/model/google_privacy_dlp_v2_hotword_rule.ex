...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2HotwordRule do
  ...
  - hotwordRegex (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Regex.t): Regular expression pattern defining what qualifies as a hotword. Defaults to `nil`.
  - likelihoodAdjustment (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2LikelihoodAdjustment.t): Likelihood adjustment to apply to all matching findings. Defaults to `nil`.
  - proximity (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Proximity.t): Proximity of the finding within which the entire hotword must reside.
  ...
  is the area code in question. Defaults to `nil`.
  """
