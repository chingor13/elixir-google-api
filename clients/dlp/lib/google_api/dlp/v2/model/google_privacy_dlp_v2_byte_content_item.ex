...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ByteContentItem do
  ...
  - data (String.t): Content data to inspect or redact. Defaults to `nil`.
  - type (String.t): The type of data stored in the bytes string. Default will be TEXT_UTF8. Defaults to `nil`.
  """
