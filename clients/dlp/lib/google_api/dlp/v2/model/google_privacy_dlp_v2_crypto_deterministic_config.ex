...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CryptoDeterministicConfig do
  ...
  - context (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FieldId.t): Optional. A context may be used for higher security and maintaining
  ...
  applied to both structured and non-structured `ContentItem`s. Defaults to `nil`.
  - cryptoKey (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CryptoKey.t): The key used by the encryption function. Defaults to `nil`.
  - surrogateInfoType (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InfoType.t): The custom info type to annotate the surrogate with.
