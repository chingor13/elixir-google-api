...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2PrivacyMetric do
  ...
  - categoricalStatsConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CategoricalStatsConfig.t):  Defaults to `nil`.
  - deltaPresenceEstimationConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeltaPresenceEstimationConfig.t):  Defaults to `nil`.
  - kAnonymityConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2KAnonymityConfig.t):  Defaults to `nil`.
  - kMapEstimationConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2KMapEstimationConfig.t):  Defaults to `nil`.
  - lDiversityConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2LDiversityConfig.t):  Defaults to `nil`.
  - numericalStatsConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2NumericalStatsConfig.t):  Defaults to `nil`.
  """
