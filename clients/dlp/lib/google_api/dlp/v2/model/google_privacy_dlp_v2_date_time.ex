...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DateTime do
  ...
  - date (GoogleApi.DLP.V2.Model.GoogleTypeDate.t): One or more of the following must be set. All fields are optional, but
  when set must be valid date or time values. Defaults to `nil`.
  - dayOfWeek (String.t):  Defaults to `nil`.
  - time (GoogleApi.DLP.V2.Model.GoogleTypeTimeOfDay.t):  Defaults to `nil`.
  - timeZone (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2TimeZone.t):  Defaults to `nil`.
  """
