...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2RequestedOptions do
  ...
  - jobConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectJobConfig.t):  Defaults to `nil`.
  - snapshotInspectTemplate (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectTemplate.t): If run with an InspectTemplate, a snapshot of its state at the time of
  this run. Defaults to `nil`.
  """
