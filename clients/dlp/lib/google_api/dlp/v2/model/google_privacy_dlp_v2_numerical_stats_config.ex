...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2NumericalStatsConfig do
  ...
  - field (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FieldId.t): Field to compute numerical stats on. Supported types are
  integer, float, date, datetime, timestamp, time. Defaults to `nil`.
  """
