...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Expressions do
  ...
  - conditions (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Conditions.t):  Defaults to `nil`.
  - logicalOperator (String.t): The operator to apply to the result of conditions. Default and currently
  only supported value is `AND`. Defaults to `nil`.
  """
