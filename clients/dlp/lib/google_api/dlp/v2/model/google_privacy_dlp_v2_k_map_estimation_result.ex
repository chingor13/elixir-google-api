...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2KMapEstimationResult do
  ...
  - kMapEstimationHistogram (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2KMapEstimationHistogramBucket.t)): The intervals [min_anonymity, max_anonymity] do not overlap. If a value
  ...
  larger than 10. Defaults to `nil`.
  """
