...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CloudStorageRegexFileSet do
  ...
  * `{bucket_name: "mybucket", include_regex: ["directory/[^/]+"]}` will
  ...
  - bucketName (String.t): The name of a Cloud Storage bucket. Required. Defaults to `nil`.
  - excludeRegex (list(String.t)): A list of regular expressions matching file paths to exclude. All files in
  the bucket that match at least one of these regular expressions will be
  excluded from the scan.

  Regular expressions use RE2
  [syntax](https://github.com/google/re2/wiki/Syntax); a guide can be found
  under the google/re2 repository on GitHub. Defaults to `nil`.
  - includeRegex (list(String.t)): A list of regular expressions matching file paths to include. All files in
  the bucket that match at least one of these regular expressions will be
