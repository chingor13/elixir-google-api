...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2LDiversityResult do
  ...
  - sensitiveValueFrequencyHistogramBuckets (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2LDiversityHistogramBucket.t)): Histogram of l-diversity equivalence class sensitive value frequencies. Defaults to `nil`.
  """
