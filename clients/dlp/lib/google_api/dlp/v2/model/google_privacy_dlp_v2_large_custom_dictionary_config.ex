...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2LargeCustomDictionaryConfig do
  ...
  - bigQueryField (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2BigQueryField.t): Field in a BigQuery table where each cell represents a dictionary phrase. Defaults to `nil`.
  - cloudStorageFileSet (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CloudStorageFileSet.t): Set of files containing newline-delimited lists of dictionary phrases. Defaults to `nil`.
  - outputPath (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CloudStoragePath.t): Location to store dictionary artifacts in Google Cloud Storage. These files
  will only be accessible by project owners and the DLP API. If any of these
  artifacts are modified, the dictionary is considered invalid and can no
  longer be used. Defaults to `nil`.
  """
