...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StoredInfoTypeVersion do
  ...
  - config (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StoredInfoTypeConfig.t): StoredInfoType configuration. Defaults to `nil`.
  - createTime (DateTime.t): Create timestamp of the version. Read-only, determined by the system
  when the version is created. Defaults to `nil`.
  - errors (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Error.t)): Errors that occurred when creating this storedInfoType version, or
  ...
  not the source of the error. Defaults to `nil`.
  - state (String.t): Stored info type version state. Read-only, updated by the system
  during dictionary creation. Defaults to `nil`.
  - stats (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StoredInfoTypeStats.t): Statistics about this storedInfoType version. Defaults to `nil`.
  """
