...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CreateJobTriggerRequest do
  ...
  - jobTrigger (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2JobTrigger.t): The JobTrigger to create. Defaults to `nil`.
  - triggerId (String.t): The trigger id can contain uppercase and lowercase letters,
