...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectDataSourceDetails do
  ...
  - requestedOptions (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2RequestedOptions.t): The configuration used for this job. Defaults to `nil`.
  - result (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Result.t): A summary of the outcome of this inspect job. Defaults to `nil`.
  """
