...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StorageConfig do
  ...
  - bigQueryOptions (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2BigQueryOptions.t): BigQuery options specification. Defaults to `nil`.
  - cloudStorageOptions (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CloudStorageOptions.t): Google Cloud Storage options specification. Defaults to `nil`.
  - datastoreOptions (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DatastoreOptions.t): Google Cloud Datastore options specification. Defaults to `nil`.
  - timespanConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2TimespanConfig.t):  Defaults to `nil`.
  """
