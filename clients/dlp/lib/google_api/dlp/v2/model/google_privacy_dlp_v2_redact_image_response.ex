...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2RedactImageResponse do
  ...
  - extractedText (String.t): If an image was being inspected and the InspectConfig's include_quote was
  set to true, then this field will include all text, if any, that was found
  in the image. Defaults to `nil`.
  - inspectResult (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectResult.t): The findings. Populated when include_findings in the request is true. Defaults to `nil`.
  - redactedImage (String.t): The redacted image. The type will be the same as the original image. Defaults to `nil`.
  """
