...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DateShiftConfig do
  ...
  - context (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FieldId.t): Points to the field that contains the context, for example, an entity id.
  If set, must also set method. If set, shift will be consistent for the
  given context. Defaults to `nil`.
  - cryptoKey (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CryptoKey.t): Causes the shift to be computed based on this key and the context. This
  results in the same shift for the same context and crypto_key. Defaults to `nil`.
