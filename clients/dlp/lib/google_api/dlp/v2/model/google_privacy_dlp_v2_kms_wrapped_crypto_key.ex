...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2KmsWrappedCryptoKey do
  ...
  - cryptoKeyName (String.t): The resource name of the KMS CryptoKey to use for unwrapping. [required] Defaults to `nil`.
  - wrappedKey (String.t): The wrapped data crypto key. [required] Defaults to `nil`.
  """
