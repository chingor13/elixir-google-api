...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2UpdateStoredInfoTypeRequest do
  ...
  - config (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StoredInfoTypeConfig.t): Updated configuration for the storedInfoType. If not provided, a new
  version of the storedInfoType will be created with the existing
  configuration. Defaults to `nil`.
  - updateMask (String.t): Mask to control which fields get updated. Defaults to `nil`.
  """
