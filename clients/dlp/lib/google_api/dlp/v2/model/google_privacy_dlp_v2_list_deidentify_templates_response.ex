...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ListDeidentifyTemplatesResponse do
  ...
  - deidentifyTemplates (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeidentifyTemplate.t)): List of deidentify templates, up to page_size in
  ListDeidentifyTemplatesRequest. Defaults to `nil`.
  - nextPageToken (String.t): If the next page is available then the next page token to be used
  in following ListDeidentifyTemplates request. Defaults to `nil`.
  """
