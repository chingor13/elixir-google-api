...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2NumericalStatsResult do
  ...
  - maxValue (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Value.t): Maximum value appearing in the column. Defaults to `nil`.
  - minValue (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Value.t): Minimum value appearing in the column. Defaults to `nil`.
  - quantileValues (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Value.t)): List of 99 values that partition the set of field values into 100 equal
  sized buckets. Defaults to `nil`.
  """
