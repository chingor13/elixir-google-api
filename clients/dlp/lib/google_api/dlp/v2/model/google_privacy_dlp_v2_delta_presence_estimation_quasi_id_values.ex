...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeltaPresenceEstimationQuasiIdValues do
  ...
  - estimatedProbability (float()): The estimated probability that a given individual sharing these
  ...
  *and* outside the dataset) with these quasi-identifier values.
  ...
  population with these values, then δ is 0.15. Defaults to `nil`.
  - quasiIdsValues (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Value.t)): The quasi-identifier values. Defaults to `nil`.
  """
