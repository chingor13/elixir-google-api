...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2RecordLocation do
  ...
  - fieldId (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FieldId.t): Field id of the field containing the finding. Defaults to `nil`.
  - recordKey (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2RecordKey.t): Key of the finding. Defaults to `nil`.
  - tableLocation (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2TableLocation.t): Location within a `ContentItem.Table`. Defaults to `nil`.
  """
