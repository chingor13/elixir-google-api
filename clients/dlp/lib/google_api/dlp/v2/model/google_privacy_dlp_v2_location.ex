...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Location do
  ...
  - byteRange (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Range.t): Zero-based byte offsets delimiting the finding.
  These are relative to the finding's containing element.
  Note that when the content is not textual, this references
  the UTF-8 encoded textual representation of the content.
  Omitted if content is an image. Defaults to `nil`.
  - codepointRange (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Range.t): Unicode character offsets delimiting the finding.
  These are relative to the finding's containing element.
  Provided when the content is text. Defaults to `nil`.
  - contentLocations (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ContentLocation.t)): List of nested objects pointing to the precise location of the finding
  within the file or record. Defaults to `nil`.
  """
