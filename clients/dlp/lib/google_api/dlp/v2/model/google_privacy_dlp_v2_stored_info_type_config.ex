...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StoredInfoTypeConfig do
  ...
  - description (String.t): Description of the StoredInfoType (max 256 characters). Defaults to `nil`.
  - displayName (String.t): Display name of the StoredInfoType (max 256 characters). Defaults to `nil`.
  - largeCustomDictionary (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2LargeCustomDictionaryConfig.t): StoredInfoType where findings are defined by a dictionary of phrases. Defaults to `nil`.
  """
