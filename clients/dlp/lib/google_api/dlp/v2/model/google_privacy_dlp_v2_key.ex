...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Key do
  ...
  - partitionId (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2PartitionId.t): Entities are partitioned into subsets, currently identified by a project
  ID and namespace ID.
  Queries are scoped to a single partition. Defaults to `nil`.
  - path (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2PathElement.t)): The entity path.
