...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectJobConfig do
  ...
  - actions (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Action.t)): Actions to execute at the completion of the job. Defaults to `nil`.
  - inspectConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectConfig.t): How and what to scan for. Defaults to `nil`.
  - inspectTemplateName (String.t): If provided, will be used as the default for all values in InspectConfig.
  `inspect_config` will be merged into the values persisted as part of the
  template. Defaults to `nil`.
  - storageConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StorageConfig.t): The data to scan. Defaults to `nil`.
  """
