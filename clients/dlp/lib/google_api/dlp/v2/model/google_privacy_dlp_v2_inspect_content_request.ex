...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectContentRequest do
  ...
  - inspectConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectConfig.t): Configuration for the inspector. What specified here will override
  the template referenced by the inspect_template_name argument. Defaults to `nil`.
  ...
  - item (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ContentItem.t): The item to inspect. Defaults to `nil`.
  """
