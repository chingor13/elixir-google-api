...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectionRule do
  ...
  - exclusionRule (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ExclusionRule.t): Exclusion rule. Defaults to `nil`.
  - hotwordRule (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2HotwordRule.t): Hotword-based detection rule. Defaults to `nil`.
  """
