...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Bucket do
  ...
  - max (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Value.t): Upper bound of the range, exclusive; type must match min. Defaults to `nil`.
  - min (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Value.t): Lower bound of the range, inclusive. Type should be the same as max if
  used. Defaults to `nil`.
  - replacementValue (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Value.t): Replacement value for this bucket. If not provided
  the default behavior will be to hyphenate the min-max range. Defaults to `nil`.
  """
