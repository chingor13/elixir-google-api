...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ListInspectTemplatesResponse do
  ...
  - inspectTemplates (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectTemplate.t)): List of inspectTemplates, up to page_size in ListInspectTemplatesRequest. Defaults to `nil`.
  - nextPageToken (String.t): If the next page is available then the next page token to be used
  in following ListInspectTemplates request. Defaults to `nil`.
  """
