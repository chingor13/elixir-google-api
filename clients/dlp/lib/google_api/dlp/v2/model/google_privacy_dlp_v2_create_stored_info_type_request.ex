...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CreateStoredInfoTypeRequest do
  ...
  - config (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StoredInfoTypeConfig.t): Configuration of the storedInfoType to create. Defaults to `nil`.
  - storedInfoTypeId (String.t): The storedInfoType ID can contain uppercase and lowercase letters,
