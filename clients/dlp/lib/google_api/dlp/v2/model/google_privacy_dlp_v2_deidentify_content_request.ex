...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeidentifyContentRequest do
  ...
  - deidentifyConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeidentifyConfig.t): Configuration for the de-identification of the content item.
  Items specified here will override the template referenced by the
  deidentify_template_name argument. Defaults to `nil`.
  - deidentifyTemplateName (String.t): Optional template to use. Any configuration directly specified in
  deidentify_config will override those set in the template. Singular fields
  that are set in this request will replace their corresponding fields in the
  template. Repeated fields are appended. Singular sub-messages and groups
  are recursively merged. Defaults to `nil`.
  - inspectConfig (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectConfig.t): Configuration for the inspector.
  Items specified here will override the template referenced by the
  inspect_template_name argument. Defaults to `nil`.
  - inspectTemplateName (String.t): Optional template to use. Any configuration directly specified in
  inspect_config will override those set in the template. Singular fields
  that are set in this request will replace their corresponding fields in the
  template. Repeated fields are appended. Singular sub-messages and groups
  are recursively merged. Defaults to `nil`.
  - item (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ContentItem.t): The item to de-identify. Will be treated as text. Defaults to `nil`.
  """
