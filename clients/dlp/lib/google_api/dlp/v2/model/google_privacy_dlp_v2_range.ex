...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Range do
  ...
  - end (String.t): Index of the last character of the range (exclusive). Defaults to `nil`.
  - start (String.t): Index of the first character of the range (inclusive). Defaults to `nil`.
  """
