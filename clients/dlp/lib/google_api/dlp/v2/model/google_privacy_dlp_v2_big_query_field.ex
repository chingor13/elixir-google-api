...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2BigQueryField do
  ...
  - field (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FieldId.t): Designated field in the BigQuery table. Defaults to `nil`.
  - table (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2BigQueryTable.t): Source table of the field. Defaults to `nil`.
  """
