...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2RecordSuppression do
  ...
  - condition (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2RecordCondition.t): A condition that when it evaluates to true will result in the record being
  evaluated to be suppressed from the transformed content. Defaults to `nil`.
  """
