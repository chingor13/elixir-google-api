...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StoredInfoType do
  ...
  - currentVersion (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StoredInfoTypeVersion.t): Current version of the stored info type. Defaults to `nil`.
  - name (String.t): Resource name. Defaults to `nil`.
  - pendingVersions (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StoredInfoTypeVersion.t)): Pending versions of the stored info type. Empty if no versions are
