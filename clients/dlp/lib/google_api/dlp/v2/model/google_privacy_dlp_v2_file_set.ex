...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FileSet do
  ...
  - regexFileSet (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CloudStorageRegexFileSet.t): The regex-filtered set of files to scan. Exactly one of `url` or
  `regex_file_set` must be set. Defaults to `nil`.
  - url (String.t): The Cloud Storage url of the file(s) to scan, in the format
  ...
  Exactly one of `url` or `regex_file_set` must be set. Defaults to `nil`.
  """
