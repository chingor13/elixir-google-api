...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2LDiversityConfig do
  ...
  - quasiIds (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FieldId.t)): Set of quasi-identifiers indicating how equivalence classes are
  defined for the l-diversity computation. When multiple fields are
  specified, they are considered a single composite key. Defaults to `nil`.
  - sensitiveAttribute (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FieldId.t): Sensitive field for computing the l-value. Defaults to `nil`.
  """
