...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ContentItem do
  ...
  - byteItem (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ByteContentItem.t): Content data to inspect or redact. Replaces `type` and `data`. Defaults to `nil`.
  - table (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Table.t): Structured content for inspection. See
  https://cloud.google.com/dlp/docs/inspecting-text#inspecting_a_table to
  learn more. Defaults to `nil`.
  - value (String.t): String data to inspect or redact. Defaults to `nil`.
  """
