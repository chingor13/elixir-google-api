...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2BigQueryTable do
  ...
  - datasetId (String.t): Dataset ID of the table. Defaults to `nil`.
  - projectId (String.t): The Google Cloud Platform project ID of the project containing the table.
  If omitted, project ID is inferred from the API call. Defaults to `nil`.
  - tableId (String.t): Name of the table. Defaults to `nil`.
  """
