...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Condition do
  ...
  - field (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FieldId.t): Field within the record this condition is evaluated against. [required] Defaults to `nil`.
  - operator (String.t): Operator used to compare the field or infoType to the value. [required] Defaults to `nil`.
  - value (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Value.t): Value to compare against. [Required, except for `EXISTS` tests.] Defaults to `nil`.
  """
