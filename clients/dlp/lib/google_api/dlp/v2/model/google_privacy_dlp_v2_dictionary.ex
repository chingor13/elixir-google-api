...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Dictionary do
  ...
  - cloudStoragePath (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CloudStoragePath.t): Newline-delimited file of words in Cloud Storage. Only a single file
  is accepted. Defaults to `nil`.
  - wordList (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2WordList.t): List of words or phrases to search for. Defaults to `nil`.
  """
