...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DatastoreOptions do
  ...
  - kind (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2KindExpression.t): The kind to process. Defaults to `nil`.
  - partitionId (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2PartitionId.t): A partition ID identifies a grouping of entities. The grouping is always
  by project and namespace, however the namespace ID may be empty. Defaults to `nil`.
  """
