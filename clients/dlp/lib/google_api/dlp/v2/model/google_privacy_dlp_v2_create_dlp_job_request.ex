...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CreateDlpJobRequest do
  ...
  - jobId (String.t): The job id can contain uppercase and lowercase letters,
  numbers, and hyphens; that is, it must match the regular
  expression: `[a-zA-Z\\d-_]+`. The maximum length is 100
  characters. Can be empty to allow the system to generate one. Defaults to `nil`.
  - riskJob (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2RiskAnalysisJobConfig.t):  Defaults to `nil`.
  """
