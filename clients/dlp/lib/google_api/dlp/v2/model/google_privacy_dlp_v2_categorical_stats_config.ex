...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CategoricalStatsConfig do
  ...
  - field (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FieldId.t): Field to compute categorical stats on. All column types are
  supported except for arrays and structs. However, it may be more
  informative to use NumericalStats when the field type is supported,
  depending on the data. Defaults to `nil`.
  """
