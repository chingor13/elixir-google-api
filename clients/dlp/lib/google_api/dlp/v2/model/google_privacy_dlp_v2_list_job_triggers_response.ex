...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ListJobTriggersResponse do
  ...
  - jobTriggers (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2JobTrigger.t)): List of triggeredJobs, up to page_size in ListJobTriggersRequest. Defaults to `nil`.
  - nextPageToken (String.t): If the next page is available then the next page token to be used
  in following ListJobTriggers request. Defaults to `nil`.
  """
