...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ContentLocation do
  ...
  - containerName (String.t): Name of the container where the finding is located.
  ...
  * Datastore namespace: <namespace>
  ...
  identifier (for an example an image contained within a document). Defaults to `nil`.
  - containerTimestamp (DateTime.t): Findings container modification timestamp, if applicable.
  For Google Cloud Storage contains last file modification timestamp.
  For BigQuery table contains last_modified_time property.
  For Datastore - not populated. Defaults to `nil`.
  - containerVersion (String.t): Findings container version, if available
  ("generation" for Google Cloud Storage). Defaults to `nil`.
  - documentLocation (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DocumentLocation.t): Location data for document files. Defaults to `nil`.
  - imageLocation (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ImageLocation.t): Location within an image's pixels. Defaults to `nil`.
  - recordLocation (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2RecordLocation.t): Location within a row or record of a database table. Defaults to `nil`.
  """
