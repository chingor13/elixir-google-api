...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CryptoReplaceFfxFpeConfig do
  ...
  - commonAlphabet (String.t):  Defaults to `nil`.
  - context (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FieldId.t): The 'tweak', a context may be used for higher security since the same
  ...
  - a string is encoded in UTF-8 format followed by a single byte of value 2 Defaults to `nil`.
  - cryptoKey (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CryptoKey.t): The key used by the encryption algorithm. [required] Defaults to `nil`.
  - customAlphabet (String.t): This is supported by mapping these to the alphanumeric characters
  that the FFX mode natively supports. This happens before/after
  encryption/decryption.
  Each character listed must appear only once.
  Number of characters must be in the range [2, 62].
  This must be encoded as ASCII.
  The order of characters does not matter. Defaults to `nil`.
  - radix (integer()): The native way to select the alphabet. Must be in the range [2, 62]. Defaults to `nil`.
  - surrogateInfoType (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InfoType.t): The custom infoType to annotate the surrogate with.
