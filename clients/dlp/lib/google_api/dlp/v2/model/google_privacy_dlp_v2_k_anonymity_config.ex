...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2KAnonymityConfig do
  ...
  - entityId (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2EntityId.t): Optional message indicating that multiple rows might be associated to a
  ...
  might be ignored. Defaults to `nil`.
  - quasiIds (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FieldId.t)): Set of fields to compute k-anonymity over. When multiple fields are
  specified, they are considered a single composite key. Structs and
  repeated data types are not supported; however, nested fields are
  supported so long as they are not structs themselves or nested within
  a repeated field. Defaults to `nil`.
  """
