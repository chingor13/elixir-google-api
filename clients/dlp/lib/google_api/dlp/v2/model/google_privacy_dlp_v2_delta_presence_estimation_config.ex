...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeltaPresenceEstimationConfig do
  ...
  - auxiliaryTables (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StatisticalTable.t)): Several auxiliary tables can be used in the analysis. Each custom_tag
  used to tag a quasi-identifiers field must appear in exactly one
  field of one auxiliary table. Defaults to `nil`.
  - quasiIds (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2QuasiId.t)): Fields considered to be quasi-identifiers. No two fields can have the
  same tag. [required] Defaults to `nil`.
  - regionCode (String.t): ISO 3166-1 alpha-2 region code to use in the statistical modeling.
  Required if no column is tagged with a region-specific InfoType (like
  US_ZIP_5) or a region code. Defaults to `nil`.
  """
