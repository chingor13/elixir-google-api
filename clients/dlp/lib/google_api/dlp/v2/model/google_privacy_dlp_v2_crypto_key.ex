...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CryptoKey do
  ...
  - kmsWrapped (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2KmsWrappedCryptoKey.t):  Defaults to `nil`.
  - transient (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2TransientCryptoKey.t):  Defaults to `nil`.
  - unwrapped (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2UnwrappedCryptoKey.t):  Defaults to `nil`.
  """
