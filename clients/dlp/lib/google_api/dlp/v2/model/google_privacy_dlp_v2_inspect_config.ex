...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectConfig do
  ...
  - contentOptions (list(String.t)): List of options defining data content to scan.
  If empty, text, images, and other content will be included. Defaults to `nil`.
  - customInfoTypes (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CustomInfoType.t)): CustomInfoTypes provided by the user. See
  https://cloud.google.com/dlp/docs/creating-custom-infotypes to learn more. Defaults to `nil`.
  - excludeInfoTypes (boolean()): When true, excludes type information of the findings. Defaults to `nil`.
  - includeQuote (boolean()): When true, a contextual quote from the data that triggered a finding is
  included in the response; see Finding.quote. Defaults to `nil`.
  - infoTypes (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InfoType.t)): Restricts what info_types to look for. The values must correspond to
  ...
  specific InfoTypes listed in the reference. Defaults to `nil`.
  - limits (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2FindingLimits.t):  Defaults to `nil`.
  - minLikelihood (String.t): Only returns findings equal or above this threshold. The default is
  POSSIBLE.
  See https://cloud.google.com/dlp/docs/likelihood to learn more. Defaults to `nil`.
  - ruleSet (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectionRuleSet.t)): Set of rules to apply to the findings for this InspectConfig.
  Exclusion rules, contained in the set are executed in the end, other
  rules are executed in the order they are specified for each info type. Defaults to `nil`.
  """
