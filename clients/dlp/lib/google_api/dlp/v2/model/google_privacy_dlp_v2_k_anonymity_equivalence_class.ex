...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2KAnonymityEquivalenceClass do
  ...
  - equivalenceClassSize (String.t): Size of the equivalence class, for example number of rows with the
  above set of values. Defaults to `nil`.
  - quasiIdsValues (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Value.t)): Set of values defining the equivalence class. One value per
  quasi-identifier column in the original KAnonymity metric message.
  The order is always the same as the original request. Defaults to `nil`.
  """
