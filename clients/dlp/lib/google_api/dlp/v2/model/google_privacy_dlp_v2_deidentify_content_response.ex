...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeidentifyContentResponse do
  ...
  - item (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2ContentItem.t): The de-identified item. Defaults to `nil`.
  - overview (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2TransformationOverview.t): An overview of the changes that were made on the `item`. Defaults to `nil`.
  """
