...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeltaPresenceEstimationResult do
  ...
  - deltaPresenceEstimationHistogram (list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeltaPresenceEstimationHistogramBucket.t)): The intervals [min_probability, max_probability) do not overlap. If a
  ...
  nor larger or equal to 0.4. Defaults to `nil`.
  """
