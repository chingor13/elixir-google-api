...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InfoTypeDescription do
  ...
  - description (String.t): Description of the infotype. Translated when language is provided in the
  request. Defaults to `nil`.
  - displayName (String.t): Human readable form of the infoType name. Defaults to `nil`.
  - name (String.t): Internal name of the infoType. Defaults to `nil`.
  - supportedBy (list(String.t)): Which parts of the API supports this InfoType. Defaults to `nil`.
  """
