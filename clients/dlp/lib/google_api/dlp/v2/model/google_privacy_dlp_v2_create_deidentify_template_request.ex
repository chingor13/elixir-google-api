...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CreateDeidentifyTemplateRequest do
  ...
  - deidentifyTemplate (GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeidentifyTemplate.t): The DeidentifyTemplate to create. Defaults to `nil`.
  - templateId (String.t): The template id can contain uppercase and lowercase letters,
