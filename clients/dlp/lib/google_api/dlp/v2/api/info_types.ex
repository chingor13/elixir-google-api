...
defmodule GoogleApi.DLP.V2.Api.InfoTypes do
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :filter (String.t): Optional filter to only return infoTypes supported by certain parts of the
  API. Defaults to supported_by=INSPECT.
    - :languageCode (String.t): Optional BCP-47 language code for localized infoType friendly
