...
defmodule GoogleApi.DLP.V2.Api.Organizations do
  ...
  {:error, info} on failure
  """
  @spec dlp_organizations_deidentify_templates_delete(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  {:error, info} on failure
  """
  @spec dlp_organizations_deidentify_templates_get(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeidentifyTemplate.t()}
          | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec dlp_organizations_deidentify_templates_patch(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeidentifyTemplate.t()}
          | {:error, Tesla.Env.t()}
