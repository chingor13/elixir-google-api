...
defmodule GoogleApi.CloudTasks.V2beta2.Model.LeaseTasksRequest do
  ...
  - maxTasks (integer()): The maximum number of tasks to lease.  The system will make a best effort to return as close to as &#x60;max_tasks&#x60; as possible.  The largest that &#x60;max_tasks&#x60; can be is 1000. Defaults to: `null`.
  - responseView (String.t): The response_view specifies which subset of the Task will be returned.  By default response_view is BASIC; not all information is retrieved by default because some data, such as payloads, might be desirable to return only when needed because of its large size or because of the sensitivity of data that it contains.  Authorization for FULL requires &#x60;cloudtasks.tasks.fullView&#x60; [Google IAM](/iam/) permission on the Task resource. Defaults to: `null`.
