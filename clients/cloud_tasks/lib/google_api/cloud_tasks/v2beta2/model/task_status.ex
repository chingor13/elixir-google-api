...
defmodule GoogleApi.CloudTasks.V2beta2.Model.TaskStatus do
  ...
  - attemptResponseCount (integer()): Output only. The number of attempts which have received a response.  This field is not calculated for [pull tasks](google.cloud.tasks.v2beta2.PullTaskTarget). Defaults to: `null`.
  - firstAttemptStatus (AttemptStatus): Output only. The status of the task&#39;s first attempt.  Only dispatch_time will be set. The other AttemptStatus information is not retained by Cloud Tasks.  This field is not calculated for [pull tasks](google.cloud.tasks.v2beta2.PullTaskTarget). Defaults to: `null`.
  - lastAttemptStatus (AttemptStatus): Output only. The status of the task&#39;s last attempt.  This field is not calculated for [pull tasks](google.cloud.tasks.v2beta2.PullTaskTarget). Defaults to: `null`.
  """
